...
class ApiBasicAuth(BasicAuth):
	def check_auth(self, username, password, allowed_roles, resources, method):
		# This is allowed for all resources
		if method == 'GET':
			return True
...
ext.add_model(models.User, **settings.DOMAIN_EVE['users'])
ext.add_model(models.Issue, **settings.DOMAIN_EVE['issues'])
ext.add_model(models.Comment, **settings.DOMAIN_EVE['comments'])
